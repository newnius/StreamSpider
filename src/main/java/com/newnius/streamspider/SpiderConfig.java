...
public class SpiderConfig {
	...
	public static int mongodb_port = 6379;

	public static final String PATTERN_URL = "https?://\\S+";//"https?://[-_/:.a-zA-Z0-9]+";

	public static final int DEFAULT_PAGE_CACHE_SECOND = 5 * 60;

	public static final long PATTERNS_CACHE_MILLISECOND = 1 * 60 * 1000;
	
	public static final long DEFAULT_LIMITATION_RESET_INTERVAL = 10 * 60;
	
	public static final int DEFAULT_LIMITATION = -1;
	
	public static final int DEFAULT_FREQUENCY = 1* 60 * 60;
